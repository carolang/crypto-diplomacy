...
class TestCommands:
    def test_can_move_to_an_adjacent_territory(self):
        ...
        my_map = Map(land_names=land_names, sea_names=[], player_names=[player1])
        ...
        assert my_map.unit_of(land2).commander().name() == player1
    ...
    def test_cannot_move_from_land_to_sea(self):
        ...
        my_map = Map(land_names=[land], sea_names=[sea], player_names=[player1])
